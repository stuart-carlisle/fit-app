  ...
  return{
    ...
    plugins:[
      ...
      new webpack.DefinePlugin({
        ...
        'process.env.FIREBASE_API_KEY2': JSON.stringify(process.env.FIREBASE_API_KEY2),
        'process.env.FIREBASE_DATABASE_URL2': JSON.stringify(process.env.FIREBASE_DATABASE_URL2),
