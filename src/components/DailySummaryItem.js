...
export const DailySummaryItem = (props) => {
    ...
    <Link className="summary" to={'/diary'} >
    <div className={useFade()}>
    <div className="summary-text__mobile-title show-for-mobile">{displayDate}</div>
    <span className="summary-text__date summary-item--span-dashboard">
      <div className="summary-text__date show-for-tablet">{displayDate}</div> 
...
export default connect(mapStateToProps, mapDispatchToProps)(DailySummaryItem)